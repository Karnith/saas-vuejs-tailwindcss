              ...
              <thead>
                ...
                >
                  ...
                  <th
                    class="px-6 py-2 bg-gray-200 text-left text-xs leading-2 font-medium text-gray-500 uppercase tracking-wider"
                  >
                    {{ $t("models.expense.description") }}
                  </th>
                  <th
                    class="px-6 py-2 bg-gray-200 text-left text-xs leading-2 font-medium text-gray-500 uppercase tracking-wider"
                  >
                    {{ $t("models.expense.quantity") }}
                  </th>
                  <th
                    class="px-6 py-2 bg-gray-200 text-left text-xs leading-2 font-medium text-gray-500 uppercase tracking-wider"
                  >
                    {{ $t("models.expense.price") }}
                  </th>
                  <th
                    class="px-6 py-2 bg-gray-200 text-left text-xs leading-2 font-medium text-gray-500 uppercase tracking-wider"
                  >
                    {{ $t("models.expense.amount") }}
                  </th>
                  <th
                    class="px-6 py-2 bg-gray-200 text-left text-xs leading-2 font-medium text-gray-500 uppercase tracking-wider"
                  >
                    {{ $t("models.expense.category") }}
                  </th>
                  <th
                    class="px-6 py-2 bg-gray-200 text-left text-xs leading-2 font-medium text-gray-500 uppercase tracking-wider"
                  >
                    {{ $t("models.expense.date") }}
                  </th>
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                ...
                >
                  ...
                  >
                    <router-link
                      :to="{
                        path: '/app/expenses/' + item.id + '/edit',
                      }"
...
import { transactionCategories } from "../../../services/core/FakeExpenseServer";
@Component({
...
export default class Expenses extends BaseComponent {
  ...
  categoryDescription(item: Expense) {
    const category = transactionCategories.find((f) => f.id === item.category);
    if (category) {
