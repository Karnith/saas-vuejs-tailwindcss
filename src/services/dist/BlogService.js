...
var content_api_1 = require("@tryghost/content-api");
var BlogService = /** @class */ (function () {
    function BlogService() {
        try {
            this.api = new content_api_1["default"]({
    ...
    BlogService.prototype.getPosts = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.api.posts
                            .browse({
                            limit: "all"
                        })["catch"](function (err) {
                            console.error(err);
    ...
    BlogService.prototype.getPost = function (slug) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.api.posts.read({
                            slug: slug
                        })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
